...
<div class="navbar1">
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content">
      <a href="adduser.php">Add a Customer</a>
      <a href="allusers.php">View all customers</a>
    </div>
  </div>
  <div class="dropdown">
    ...
    <div class="dropdown-content">
      <a href="addsales.php">Create a new Bill</a>
      <a href="allbills.php">View all Bills</a>
    </div>
  </div>
  <div class="dropdown">
    ...
    <div class="dropdown-content">
      <a href="additems.php">Add items to Database</a>
      <a href="allitems.php">View all items</a>
    </div>
  </div>
  <div class="ff">
